...
ActiveRecord::Schema.define(version: 20160616115910) do
  ...
  add_index "sizes", ["specification_id"], name: "index_sizes_on_specification_id", using: :btree
  ...
  add_foreign_key "sizes", "specifications"
